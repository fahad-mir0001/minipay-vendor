        ...
        <Row gutter={24}>
          <Col {...topColResponsiveProps}>
            <ChartCard
              ...
              total={yuan(126560)}
              footer={<Field label="Average Daily Sale" value={`Rs${numeral(12423).format('0,0')}`} />}
              contentHeight={46}
            >
          ...
          <Col {...topColResponsiveProps}>
            <ChartCard
              bordered={false}
              title="Operational activities effect"
              action={
                <Tooltip title="Indicator Description">
                  <Icon type="info-circle-o" />
                </Tooltip>
              ...
              footer={
                <div style={{ whiteSpace: 'nowrap', overflow: 'hidden' }}>
                  ...
                  <Trend flag="down">
                    Ratio<span className={styles.trendText}>11%</span>
                  </Trend>
                </div>
              }
              contentHeight={46}
